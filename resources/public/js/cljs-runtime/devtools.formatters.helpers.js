...
var G__58439 = devtools.prefs.pref(v);
v = G__58439;
continue;
} else {
return v;
...
}catch (e58395){var _e__53344__auto__ = e58395;
return false;
}})();
...
}catch (e58401){var _e__53344__auto__ = e58401;
return false;
}})();
...
}catch (e58406){var _e__53344__auto__ = e58406;
return false;
}}
}
});
...
var vec__58418 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58418,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58418,(1),null);
...
return cljs.core.some((function (p1__58424_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__58424_SHARP_);
}),template);
});
