 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__68672){
var vec__68673 = p__68672;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68673,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68673,(1),null);
return (function (s){
...
var len__4736__auto___68716 = arguments.length;
var i__4737__auto___68717 = (0);
while(true){
if((i__4737__auto___68717 < len__4736__auto___68716)){
args__4742__auto__.push((arguments[i__4737__auto___68717]));

var G__68718 = (i__4737__auto___68717 + (1));
i__4737__auto___68717 = G__68718;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__68682_SHARP_){
return (p1__68682_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__68682_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__68682_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq68684){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq68684));
}));
...
var map__68698 = temp__5718__auto__;
var map__68698__$1 = (((((!((map__68698 == null))))?(((((map__68698.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68698.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68698):map__68698);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68698__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68698__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68698__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__68725 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__68726 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__68708 = tag;
var G__68708__$1 = (((G__68708 instanceof cljs.core.Keyword))?G__68708.fqn:null);
switch (G__68708__$1) {
case "string":
return chunk;
