...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_64119 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_64119(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_64124 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_64124(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_64126 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_64126(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_64131 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_64131(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_64134 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_64134(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_64135 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_64135(reader);
}
});
...
var G__64270 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__64271 = s.append(c);
c = G__64270;
s = G__64271;
continue;
}
