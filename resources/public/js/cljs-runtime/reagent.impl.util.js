...
var vec__60286 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__60288;
var parts = seq__60287__$1;
...
var vec__60289 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str__$1,/-/);
var seq__60290 = cljs.core.seq(vec__60289);
var first__60291 = cljs.core.first(seq__60290);
var seq__60290__$1 = cljs.core.next(seq__60290);
var start = first__60291;
var parts = seq__60290__$1;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.str,start,cljs.core.map.cljs$core$IFn$_invoke$arity$2(reagent.impl.util.capitalize,parts));
}
});
...
(reagent.impl.util.PartialFn.prototype.call = (function (unused__10883__auto__){
var self__ = this;
var self__ = this;
var G__60308 = (arguments.length - (1));
switch (G__60308) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args60307){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args60307)));
}));
...
args_arr__4757__auto__.push((arguments[i__4737__auto___60432]));
...
/** @this {Function} */
(reagent.impl.util.class_names.cljs$lang$applyTo = (function (seq60339){
...
default:
var args_arr__4757__auto__ = [];
var len__4736__auto___60443 = arguments.length;
var i__4737__auto___60444 = (0);
while(true){
if((i__4737__auto___60444 < len__4736__auto___60443)){
args_arr__4757__auto__.push((arguments[i__4737__auto___60444]));

var G__60448 = (i__4737__auto___60444 + (1));
i__4737__auto___60444 = G__60448;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.util.merge_props.cljs$lang$applyTo = (function (seq60383){
var G__60384 = cljs.core.first(seq60383);
var seq60383__$1 = cljs.core.next(seq60383);
var G__60385 = cljs.core.first(seq60383__$1);
var seq60383__$2 = cljs.core.next(seq60383__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60384,G__60385,seq60383__$2);
}));
...
var _STAR_always_update_STAR__temp_val__60395 = true;
