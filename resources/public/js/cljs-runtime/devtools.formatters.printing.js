...
var G__58708 = (i__4737__auto___58706 + (1));
i__4737__auto___58706 = G__58708;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq58620){
var G__58621 = cljs.core.first(seq58620);
var seq58620__$1 = cljs.core.next(seq58620);
var G__58622 = cljs.core.first(seq58620__$1);
var seq58620__$2 = cljs.core.next(seq58620__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58621,G__58622,seq58620__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__58661_SHARP_){
return (!((cljs.core.meta(p1__58661_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58670__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e58678){var _e__53344__auto__ = e58678;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e58680){var _e__53344__auto__ = e58680;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__58686 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__58687 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__58687);

try{var map__58691 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58691__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__58686);
}});
...
var temp__5718__auto___58749 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5718__auto___58749)){
var managed_print_level_58750 = temp__5718__auto___58749;
var _STAR_print_level_STAR__orig_val__58698_58751 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__58699_58752 = managed_print_level_58750;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__58699_58752);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__58694_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__58694_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__58698_58751);
}} else {
job_fn();
}
