...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__63582_SHARP_,p2__63583_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__63582_SHARP_,p2__63583_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function re_com$tour$initialise_tour_$_iter__63590(s__63591){
return (new cljs.core.LazySeq(null,(function (){
var s__63591__$1 = s__63591;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__63591__$1);
if(temp__5720__auto__){
var s__63591__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63591__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__63591__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__63593 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__63592 = (0);
while(true){
if((i__63592 < size__4528__auto__)){
var step = cljs.core._nth(c__4527__auto__,i__63592);
cljs.core.chunk_append(b__63593,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__63643 = (i__63592 + (1));
i__63592 = G__63643;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63593),re_com$tour$initialise_tour_$_iter__63590(cljs.core.chunk_rest(s__63591__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63593),null);
}
} else {
var step = cljs.core.first(s__63591__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__63590(cljs.core.rest(s__63591__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__63611 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__63611.cljs$core$IFn$_invoke$arity$1 ? fexpr__63611.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63611.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__63619 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__63619.cljs$core$IFn$_invoke$arity$1 ? fexpr__63619.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63619.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__63620 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__63620.cljs$core$IFn$_invoke$arity$1 ? fexpr__63620.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63620.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__63623 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__63623.cljs$core$IFn$_invoke$arity$1 ? fexpr__63623.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63623.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__63624 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__63624.cljs$core$IFn$_invoke$arity$1 ? fexpr__63624.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63624.call(null,tour));
})(),true);
} else {
return null;
}
