...
var G__60934 = o;
goog.object.set(G__60934,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__61066__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__61066 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__61067__i = 0, G__61067__a = new Array(arguments.length -  0);
while (G__61067__i < G__61067__a.length) {G__61067__a[G__61067__i] = arguments[G__61067__i + 0]; ++G__61067__i;}
  args = new cljs.core.IndexedSeq(G__61067__a,0,null);
} 
return G__61066__delegate.call(this,args);};
G__61066.cljs$lang$maxFixedArity = 0;
G__61066.cljs$lang$applyTo = (function (arglist__61068){
var args = cljs.core.seq(arglist__61068);
return G__61066__delegate(args);
});
G__61066.cljs$core$IFn$_invoke$arity$variadic = G__61066__delegate;
return G__61066;
})()
;
} else {
...
var G__60966 = o;
goog.object.set(G__60966,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__61069__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__61069 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__61070__i = 0, G__61070__a = new Array(arguments.length -  0);
while (G__61070__i < G__61070__a.length) {G__61070__a[G__61070__i] = arguments[G__61070__i + 0]; ++G__61070__i;}
  args = new cljs.core.IndexedSeq(G__61070__a,0,null);
} 
return G__61069__delegate.call(this,args);};
G__61069.cljs$lang$maxFixedArity = 0;
G__61069.cljs$lang$applyTo = (function (arglist__61071){
var args = cljs.core.seq(arglist__61071);
return G__61069__delegate(args);
});
G__61069.cljs$core$IFn$_invoke$arity$variadic = G__61069__delegate;
return G__61069;
})()
;
} else {
...
var G__60977 = props;
var G__60977__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60977,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__60977);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60977__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__60977__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__60982 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60982,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__60982;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__60991){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60993__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__61004_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__61004_SHARP_);
}));
} else {
return null;
}
...
var vec__61035 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61035,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61035,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61035,(2),null);
...
var temp__5724__auto___61087 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___61087 == null)){
} else {
var key_61088 = temp__5724__auto___61087;
(jsprops.key = key_61088);
}
...
var temp__5724__auto___61089 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___61089 == null)){
} else {
var key_61090 = temp__5724__auto___61089;
(jsprops.key = key_61090);
}
...
var G__61045 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__61045) : reagent.impl.template.as_element.call(null,G__61045));
} else {
var temp__5724__auto___61092 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___61092 == null)){
} else {
var key_61093 = temp__5724__auto___61092;
(jsprops.key = key_61093);
}
...
var G__61047 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__61047)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq61048){
var G__61049 = cljs.core.first(seq61048);
var seq61048__$1 = cljs.core.next(seq61048);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61049,seq61048__$1);
}));
...
break;
default:
var G__61103 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__61103;
continue;
...
var ctx = ({});
var vec__61059 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61059,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61059,(1),null);
...
var G__61064 = (cljs.core.count(argv) - first_child);
switch (G__61064) {
case (0):
