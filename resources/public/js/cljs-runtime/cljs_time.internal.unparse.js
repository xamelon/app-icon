...
var periods__$1 = cljs.core.vec((function (){var G__62761 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62760_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__62760_SHARP_,(0),(3));
}),G__62761);
} else {
return G__62761;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__62768){
var vec__62769 = p__62768;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62769,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62769,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__62772 = pattern;
switch (G__62772) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62772)].join('')));
...
var G__62784 = key;
var G__62784__$1 = (((G__62784 instanceof cljs.core.Keyword))?G__62784.fqn:null);
switch (G__62784__$1) {
case "millis":
return (function (p1__62776_SHARP_){
return p1__62776_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__62777_SHARP_){
return p1__62777_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__62778_SHARP_){
return p1__62778_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__62779_SHARP_){
return p1__62779_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__62780_SHARP_){
return p1__62780_SHARP_.getHours();
});

break;
case "day":
return (function (p1__62781_SHARP_){
return p1__62781_SHARP_.getDate();
});

break;
case "month":
return (function (p1__62782_SHARP_){
return p1__62782_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__62783_SHARP_){
return p1__62783_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62784__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__62785){
...
var key = first__62788;
var args = seq__62787__$1;
var G__62789 = key;
...
break;
case "ordinal-suffix":
var vec__62790 = (function (){var G__62793 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__62793) : syntax_list.call(null,G__62793));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62789__$1)].join('')));
...
var d = value;
var G__62798 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__62799 = G__62798;
...
var unparser = first__62801;
var more = seq__62800__$1;
var s = "";
var d__$1 = d;
var G__62798__$1 = G__62798;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__62808 = G__62798__$1;
var seq__62809 = cljs.core.seq(vec__62808);
var first__62810 = cljs.core.first(seq__62809);
var seq__62809__$1 = cljs.core.next(seq__62809);
var unparser__$1 = first__62810;
var more__$1 = seq__62809__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__62811 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62811,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62811,(1),null);
var G__62843 = d__$3;
var G__62844 = more__$1;
var G__62845 = s__$3;
d__$1 = G__62843;
G__62798__$1 = G__62844;
s__$1 = G__62845;
continue;
}
break;
